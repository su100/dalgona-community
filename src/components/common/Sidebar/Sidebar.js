        ...
        {isAuthenticated && (
          <div className="sidebar-style__profile">
            ...
            <div className="sidebar-style__profile-myinformation">
              <div className="sidebar-style__profile-myinformation-nickname">{profile.get('nickname')}</div>
              <div className="sidebar-style__profile-myinformation-description">{profile.get('introduction')}</div>
            </div>
          </div>
        )}
        {isAuthenticated ? (
